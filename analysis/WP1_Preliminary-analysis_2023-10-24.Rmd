...
swimmer_spider_plot <- function(site, comment, name) {
  ...
  ggsave(
    paste("../output/swimmer-spider-plot/materials/PECATI_site-", as.character({{site}}), "_swimmer_TAs_", cutoff_date, ".png", sep = ""),
    swimmer_ta,
    width = 20,
    height = 20,
    units = "cm",
  ...
  ggsave(
    paste("../output/swimmer-spider-plot/materials/PECATI_site-", as.character({{site}}), "_spider_TAs_", cutoff_date, ".png", sep = ""),
    spider_ta,
    width = 15,
    height = 20,
    units = "cm",
  ...
  ggsave(
    paste("../output/swimmer-spider-plot/PECATI_site-", as.character({{site}}), "_TAs_", cutoff_date, ".png", sep = ""),
    combined_ta,
    width = 30,
    height = 60,
    units = "cm",
...
The median (range) follow-up time is:
...
```{r, message = FALSE, warning = FALSE, echo = FALSE}
summary(survfit(Surv(os, os_event) ~ 1, data = data_13_survival))
```

```{r, message = FALSE, warning = FALSE, echo = FALSE}
summary(survfit(Surv(os, os_event) ~ 1, data = data_13_survival), times = 12)
```
...
### Save plot ---------------------------------------------------------------
ggsave(
  here("output/PECATI_Figure_OS_global_2023-10-26.png"),
  os_global,
  width = 20,
  height = 12,
  units = "cm",
...
```{r, message = FALSE, warning = FALSE, echo = FALSE}
summary(survfit(Surv(pfs, pfs_event) ~ 1, data = data_13_survival))
```

```{r, message = FALSE, warning = FALSE, echo = FALSE}
summary(survfit(Surv(pfs, pfs_event) ~ 1, data = data_13_survival), times = 12)
```

#### **Figure 4. Progression-free survival (PFS) in the intention-to-treat popilation**
...
### Save plot ---------------------------------------------------------------
ggsave(
  here("output/PECATI_Figure_PFS_global_2023-10-26.png"),
  pfs_global,
  width = 20,
  height = 12,
  units = "cm",
