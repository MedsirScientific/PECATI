...
baseline_target_n <- length(data_01a_baseline_target$patient)
```
...
data_01a_baseline_target_formatted <- data_01a_baseline_target %>% 
  select(patient, evaluation_date, longest_diameter_short_axis_mm, sum_of_lesions) %>% 
  set_names(listing5_formatted_names)
  
rmarkdown::paged_table(data_01a_baseline_target_formatted)
```
