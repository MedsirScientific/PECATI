...
```{r, message = FALSE, warning = FALSE, echo = FALSE}
tbl_delays <- pembrolizumab_delays %>%
  tbl_summary(
    missing = "no",
    percent = "column",
...
```{r, message = FALSE, warning = FALSE, echo = FALSE}
tbl_reductions <- pembrolizumab_reductions %>%
  tbl_summary(
    missing = "no",
    percent = "column",
    type = all_dichotomous() ~ "categorical",
...
```{r, message = FALSE, warning = FALSE, echo = FALSE}
tbl_temporary <- pembrolizumab_temporary_interruptions %>%
  tbl_summary(
    missing = "no",
    percent = "column",
    type = all_dichotomous() ~ "categorical",
...
```{r, message = FALSE, warning = FALSE, echo = FALSE}
tbl_permanent <- pembrolizumab_permanent_discontinuations %>%
  tbl_summary(
    missing = "no",
    percent = "column",
    type = all_dichotomous() ~ "categorical",
...
### **Table X. Pembrolizumab dose modifications**

```{r, message = FALSE, warning = FALSE, echo = FALSE}
row1 <- tbl_merge(list(tbl_delays))
row2 <- tbl_merge(list(tbl_reductions))
row3 <- tbl_merge(list(tbl_temporary))
row4 <- tbl_merge(list(tbl_permanent))
...
#### **Table 10. Summary of PFS events:**
...
#### **Table 13. Adverse Events (AEs) by maximum severity in the ITT population:**
...
#### **Table 14. Serious Adverse Events (SAEs) by maximum severity in the ITT population:**
...
#### **Table 15. Serious Adverse Events (SAEs) of grade ≥3 in the ITT population:**
...
#### **Table 16. Adverse Events (AEs) that led to the permanent discontinuation of the study drug in the ITT population:**
...
#### **Table 17. Adverse Events (AEs) that led to dose reductions in the ITT population:**
