...
# Extent of Exposure of Study Treatment
...
pembrolizumab_temporary_interruptions <- pembrolizumab_temporary_interruptions %>% 
  mutate(
    ...
    reason_no_administration = if_else(
      reason_no_administration == "Non-Medical Reason", "Non-medical reason", reason_no_administration)
  )
```
...
```{r, message = FALSE, warning = FALSE, echo = FALSE}
pembrolizumab_temporary_interruptions %>%
  tbl_summary(
    missing = "no",
    percent = "column",
    type = all_dichotomous() ~ "categorical",
...
```{r, message = FALSE, warning = FALSE, echo = FALSE}
pembrolizumab_permanent_discontinuations %>%
  tbl_summary(
    missing = "no",
    percent = "column",
    type = all_dichotomous() ~ "categorical",
