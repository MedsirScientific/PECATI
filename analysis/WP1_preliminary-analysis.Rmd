---
title: "PECATI | Preliminary data monitoring, cleaning, and analysis. January 2024"
...
project_id <- "PECATI"
cutoff_date <- as.Date("2024-01-30")
```
...
ggsave(
  here("output/PECATI_swimmer_2024-01-30.png"),
  swimmer,
  width = 2048,
  height = 4096,
  units = "px",
...
Patient 0103-002 is stable after 23 cycles of study treatment (last registered dose: 2023-12-14).
...
Patient 0105-001 is stable after 30 cycles of study treatment (last registered dose: 2023-08-30).
...
Patient 0201-001 is responding after 16 cycles of study treatment (last registered dose: 2024-01-17).

Patient 0201-002 is stable after 10 cycles of study treatment (last registered dose: 2023-09-11).

Patient 0201-003 is stable after 15 cycles of study treatment (last registered dose: 2024-01-22).

Patient 0201-004 is stable after 12 cycles of study treatment (last registered dose: 2024-01-24).
...
Patient 0202-003 discontinued the study treatment after after 17 cycles of study treatment due to XXXX (XXXX).

Patient 0202-004 is stable after 18 cycles of study treatment (last registered dose: 2024-01-11).

Patient 0202-005 discontinued the study treatment after 10 due to clinical progression but does not have any tumor assessment registered in the eCRF (last registered dose: 2023-08-04).

Patient 0202-007 is receiving the study treatment after 11 cycles but does not have any tumor assessment registered in the eCRF (last registered dose: 2023-10-30).

Patient 0202-008 is stable after 3 cycles of study treatment (last registered dose: 2024-01-15).
...
Patient 0203-001 is stable after 7 cycles of study treatment (last registered dose: 2023-08-22).

Patient 0203-002 is receiving the study treatment after 5 cycles but does not have any post-baseline tumor assessment yet (last registered dose: 2023-12-06).

Patient 0203-003 is receiving the study treatment after 1 cycle but does not have any post-baseline tumor assessment yet (last registered dose: 2023-12-05).

Patient 0203-004 is receiving the study treatment after 1 cycle but does not have any post-baseline tumor assessment yet (last registered dose: 2024-01-03).
...
Patient 0204-001 is stable after 11 cycles of study treatment (last registered dose: 2024-01-19).

Patient 0204-003 is stable after 3 cycles of study treatment (last registered dose: 2023-12-28).
...
Patient 0205-002 is receiving the study treatment after 1 cycle but does not have any post-baseline tumor assessment yet (last registered dose: 2023-10-18).
...
Patient 0206-001 is responding after 10 cycles of study treatment (last registered dose: 2024-01-15).

Patient 0206-002 is responding after 6 cycles of study treatment (last registered dose: 2024-01-19).
...
Patient 0301-003 is responding after 21 cycles of study treatment (last registered dose: 2023-12-22).

Patient 0301-004 is stable after 19 cycles of study treatment (last registered dose: 2024-01-18).

Patient 0301-005 discontinued the study treatment after 10 cycles due to clinical progression.

Patient 0301-006 is stable after 15 cycles of study treatment (last registered dose: 2024-01-18).

Patient 0301-007 is stable after 13 cycles of study treatment (last registered dose: 2024-01-04).

Patient 0301-008 is responding after 2 cycles of study treatment (last registered dose: 2023-08-03).

Patient 0301-009 is stable after 10 cycles of study treatment (last registered dose: 2024-01-24).

Patient 0301-010 is stable after 10 cycles of study treatment (last registered dose: 2024-01-26).

Patient 0301-011 is stable after 9 cycles of study treatment (last registered dose: 2024-01-29).

Patient 0301-012 is receiving the study treatment after 2 cycle but does not have any post-baseline tumor assessment yet (last registered dose: 2024-01-09).

Patient 0301-013 is receiving the study treatment after 2 cycle but does not have any post-baseline tumor assessment yet (last registered dose: 2024-01-18).

Patient 0301-014 is receiving the study treatment after 1 cycle but does not have any post-baseline tumor assessment yet (last registered dose: 2024-01-23).
