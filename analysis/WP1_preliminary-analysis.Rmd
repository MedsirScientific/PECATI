...
caption1 <- paste(strwrap(
  "5-month PFS is 97.4% (95% CI 82.8-99.6)", 90), collapse = "\n"
  )
...
caption1 <- paste(strwrap(
  "Medidan OS is Not Reached (14.8 - NR). Events: 5/41 (12.2%)", 90), collapse = "\n"
  )

caption2 <- paste(strwrap(
  "12-month OS is 97.4% (95% CI 82.8-99.6)", 90), collapse = "\n"
  )
...
caption1 <- paste(strwrap(
  "Medidan PFS is Not Reached (NR - NR). Events: 4/41 (9.8%)", 90), collapse = "\n"
  )

caption2 <- paste(strwrap(
  "12-month PFS is 82.3% (95% CI 57.8-93.3)", 90), collapse = "\n"
  )
