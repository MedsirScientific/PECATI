...
There are `r nrow(myocarditis)` with `r myocarditis$adverse_event` of  `r tolower(myocarditis$grade)`  `r tolower(myocarditis$relationship)`.
...
There are `r nrow(unique(aes_discontinuation$patient))` patients with adverse events that led to the permanent discontinuation of any study drug. Pembrolizumab was discontinued in `r nrow(unique(aes_discontinuation_pembro$patient))` patients and Lenvatinib was discontinued in `r nrow(unique(aes_discontinuation_lenva$patient))` patients.
...
There are `r nrow(unique(aes_reductions$patient))` patients with adverse events that led to dose reductions of any study drug. Pembrolizumab was reduced in `r nrow(unique(aes_reductions_pembro$patient))` patients and Lenvatinib was reduced in `r nrow(unique(aes_reductions_lenva$patient))` patients.
